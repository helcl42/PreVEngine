...
private:
    ...
    prev_test::render::ViewFrustum m_viewFrustum{ glm::radians(45.0f), 1.0f, REVERSE_DEPTH ? FAR_CLIPPING_PLANE : NEAR_CLIPPING_PLANE, REVERSE_DEPTH ? NEAR_CLIPPING_PLANE : FAR_CLIPPING_PLANE };
