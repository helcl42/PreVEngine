...
Terrain::Terrain(prev::core::device::Device& device, bool colorManaged, const int x, const int z)
    : SceneNode()
    , m_device{ device }
...
void Terrain::Init()
{
    ...
    prev_test::component::terrain::TerrainComponentFactory terrainComponentFactory{ m_device, m_colorManaged };
    ...
    m_terrainManagerComponent = prev::scene::component::NodeComponentHelper::Find<prev_test::component::terrain::ITerrainManagerComponent>(GetRoot(), { TAG_TERRAIN_MANAGER_COMPONENT });
