...
public:
    CubeRobotPart(prev::core::device::Device& device, bool colorManaged, const glm::vec3& position, const glm::quat& orientation, const glm::vec3& scale, const std::string& texturePath);
