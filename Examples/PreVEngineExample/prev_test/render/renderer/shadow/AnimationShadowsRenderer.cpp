...
AnimationShadowsRenderer::AnimationShadowsRenderer(prev::core::device::Device& device, prev::render::pass::RenderPass& renderPass, prev::scene::IScene& scene)
    : m_device{ device }
...
void AnimationShadowsRenderer::BeginFrame(const ShadowsRenderContext& renderContext)
{
...
void AnimationShadowsRenderer::EndFrame(const ShadowsRenderContext& renderContext)
{
    m_shader->EndFrame();
