...
public:
    RayCastDebugRenderer(prev::core::device::Device& device, prev::render::pass::RenderPass& renderPass, prev::scene::IScene& scene);
...
private:
    ...
    std::unique_ptr<prev::render::buffer::FrameScopedBufferPool> m_uniformsPoolGS;
