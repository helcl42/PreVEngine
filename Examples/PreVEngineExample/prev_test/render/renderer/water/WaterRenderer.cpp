...
void WaterRenderer::Init()
{
    ...
    m_shader = prev::render::shader::ShaderBuilder{ m_device }
        .AddShaderStagePaths({
            { GFX_SHADER_STAGE_VERTEX, prev_test::common::ShaderAssetManager::Instance().GetAssetPath(m_device.GetAdapter().GetInfo().backend, "water/water_vert") },
            { GFX_SHADER_STAGE_FRAGMENT, prev_test::common::ShaderAssetManager::Instance().GetAssetPath(m_device.GetAdapter().GetInfo().backend, "water/water_frag") }
        })
        ...
        .AddBindGroupEntries({
            ...
            prev::render::shader::ShaderBuilder::BindGroupEntry::Texture("reflectionTexture", 4, GFX_SHADER_STAGE_FRAGMENT, GFX_TEXTURE_VIEW_TYPE_2D),
            prev::render::shader::ShaderBuilder::BindGroupEntry::Sampler("reflectionSampler", 5, GFX_SHADER_STAGE_FRAGMENT),
            prev::render::shader::ShaderBuilder::BindGroupEntry::Texture("refractionTexture", 6, GFX_SHADER_STAGE_FRAGMENT, GFX_TEXTURE_VIEW_TYPE_2D),
            prev::render::shader::ShaderBuilder::BindGroupEntry::Sampler("refractionSampler", 7, GFX_SHADER_STAGE_FRAGMENT),
            prev::render::shader::ShaderBuilder::BindGroupEntry::Texture("depthMapTexture", 8, GFX_SHADER_STAGE_FRAGMENT, GFX_TEXTURE_VIEW_TYPE_2D, 1, GFX_TEXTURE_SAMPLE_TYPE_UNFILTERABLE_FLOAT),
            prev::render::shader::ShaderBuilder::BindGroupEntry::Sampler("depthMapSampler", 9, GFX_SHADER_STAGE_FRAGMENT, true),
            prev::render::shader::ShaderBuilder::BindGroupEntry::Texture("dudvMapTexture", 10, GFX_SHADER_STAGE_FRAGMENT, GFX_TEXTURE_VIEW_TYPE_2D),
            prev::render::shader::ShaderBuilder::BindGroupEntry::Sampler("dudvMapSampler", 11, GFX_SHADER_STAGE_FRAGMENT),
