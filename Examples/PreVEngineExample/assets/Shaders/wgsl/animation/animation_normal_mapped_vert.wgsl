...
struct AnimNormalMappedVSParams_std140_0
{
...
@binding(0) @group(0) var<uniform> uboVS_0 : AnimNormalMappedVSParams_std140_0;
...
fn vertexMain( _S1 : vertexInput_0) -> Interpolants_0
{
    ...
    var TBN_0 : mat3x3<f32> = CreateTBNMatrix_0(mat3x3<f32>(_S13[i32(0)].xyz, _S13[i32(1)].xyz, _S13[i32(2)].xyz), _S1.normal_2, _S1.tangent_1, _S1.biTangent_1);
    ...
    for(;;)
    {
        ...
        toLightVectors_0[i_0] = (((uboVS_0.lightning_0.lights_0.data_3[i_0].position_0.xyz) * (TBN_0)));
        i_0 = i_0 + i32(1);
    }
