...
struct AnimNormalMappedFSParams_std140_0
{
...
@binding(1) @group(0) var<uniform> uboFS_0 : AnimNormalMappedFSParams_std140_0;
...
{
    var _S13 : array<vec3<f32>, i32(4)> = array<vec3<f32>, i32(4)>( _S12.toLightVectorTangentSpace0_0, _S12.toLightVectorTangentSpace1_0, _S12.toLightVectorTangentSpace2_0, _S12.toLightVectorTangentSpace3_0 );
    ...
    {
        _S14 = NormalMapping_0(normalTexture_0, normalSampler_0, _S12.textureCoord_0);
    }
    else
    {
        _S14 = _S12.normal_2;
    ...
    var _S15 : vec3<f32> = normalize(_S12.toCameraVectorTangentSpace_0 - _S12.positionTangentSpace_0);
    ...
    for(;;)
    {
        ...
        var toLightVector_3 : vec3<f32> = _S13[i_1] - _S12.positionTangentSpace_0;
        var unitToLightVector_0 : vec3<f32> = normalize(toLightVector_3);
        var attenuationFactor_2 : f32 = GetAttenuationFactor_0(uboFS_0.lightning_0.lights_0.data_2[i_1].attenuation_0.xyz, toLightVector_3);
