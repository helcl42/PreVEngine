...
fn GetShadow_u0028_tA21_u003b_p1_u003b_struct_u002d_Shadows_u002d_struct_u002d_ShadowsCascade_u002d_mf44_u002d_vf41_u005b_4_u005d_u002d_u1_u002d_u11_u003b_vf3_u003b_vf3_u003b_f1_u003b(depthTexture_3: texture_2d_array<f32>, depthSampler_3: sampler, shadows: ptr<function, Shadows>, viewPosition: ptr<function, vec3<f32>>, worldPosition: ptr<function, vec3<f32>>, depthBias_3: ptr<function, f32>) -> f32 {
    ...
    if (_e70 != 0u) {
        ...
        loop {
            let _e72 = i;
            if (_e72 < 3u) {
                let _e75 = (*viewPosition)[2u];
                let _e76 = i;
                let _e81 = (*shadows).cascades[_e76].split[0u];
                if (_e75 < _e81) {
                    let _e83 = i;
                    cascadeIndex_3 = (_e83 + 1u);
                    let _e85 = bias;
                    bias = (_e85 / 1.5f);
                }
                continue;
            ...
            continuing {
                let _e87 = i;
                i = (_e87 + bitcast<u32>(1i));
            }
        }
        let _e90 = cascadeIndex_3;
        let _e94 = (*shadows).cascades[_e90].viewProjectionMatrix;
        let _e95 = (*worldPosition);
        shadowCoord_3 = (_e94 * vec4<f32>(_e95.x, _e95.y, _e95.z, 1f));
        let _e101 = shadowCoord_3;
        let _e103 = shadowCoord_3[3u];
        normalizedShadowCoord = (_e101 / vec4(_e103));
        let _e106 = normalizedShadowCoord;
        param_29 = _e106;
        let _e107 = cascadeIndex_3;
        param_30 = _e107;
        let _e108 = bias;
        param_31 = _e108;
        let _e110 = (*shadows).useReverseDepth;
        param_32 = _e110;
        let _e111 = GetShadow_u0028_tA21_u003b_p1_u003b_vf4_u003b_u1_u003b_f1_u003b_u1_u003b(depthTexture_3, depthSampler_3, (&param_29), (&param_30), (&param_31), (&param_32));
        shadow_3 = _e111;
    }
    let _e112 = shadow_3;
    return _e112;
