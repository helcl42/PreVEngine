...
struct ConeStepMappedFSParams_std140_0
{
...
@binding(1) @group(0) var<uniform> uboFS_0 : ConeStepMappedFSParams_std140_0;
...
fn fragmentMain( _S19 : pixelInput_0, @builtin(position) position_1 : vec4<f32>) -> pixelOutput_0
{
    ...
    {
        _S21 = NormalMappingGrad_0(normalTexture_0, normalSampler_0, uv_2, ddxTC_0, ddyTC_0);
    }
    else
    {
        _S21 = _S19.normal_2;
    }
    var textureColor_0 : vec4<f32> = (textureSampleGrad((colorTexture_0), (colorSampler_0), (uv_2), (ddxTC_0), (ddyTC_0)));
