...
struct TerrainFSParams_std140_0
{
...
@binding(1) @group(0) var<uniform> uboFS_0 : TerrainFSParams_std140_0;
...
{
    var shineDamper_2 : f32;
    var reflectivity_2 : f32;
    var textureColor_0 : vec4<f32>;
    ...
    var _S14 : f32 = (_S12.worldPosition_0.y + abs(uboFS_0.minHeight_0)) / (abs(uboFS_0.maxHeight_0) + abs(uboFS_0.minHeight_0));
    const _S15 : vec4<f32> = vec4<f32>(1.0f, 1.0f, 0.0f, 1.0f);
    var _S16 : vec2<f32> = dpdx(_S12.textureCoord_0);
    var _S17 : vec2<f32> = dpdy(_S12.textureCoord_0);
    var i_1 : u32 = u32(0);
    for(;;)
    {
        if(i_1 < u32(4))
        ...
        {
            var _S18 : bool;
            if(_S14 > (uboFS_0.heightSteps_0[i_1].x - uboFS_0.heightTransitionRange_0))
            {
                _S18 = _S14 < (uboFS_0.heightSteps_0[i_1].x + uboFS_0.heightTransitionRange_0);
            }
            else
            {
                _S18 = false;
            ...
            if(_S18)
            {
                var ratio_0 : f32 = (_S14 - uboFS_0.heightSteps_0[i_1].x + uboFS_0.heightTransitionRange_0) / (2.0f * uboFS_0.heightTransitionRange_0);
                var _S19 : vec3<f32> = vec3<f32>(_S12.textureCoord_0, f32(i_1));
                var _S20 : u32 = i_1 + u32(1);
                var _S21 : vec3<f32> = vec3<f32>(_S12.textureCoord_0, f32(_S20));
                var _S22 : vec4<f32> = mix((textureSampleGrad((colorTextures_0), (colorSampler_0), ((_S19)).xy, i32(((_S19)).z), (_S16), (_S17))), (textureSampleGrad((colorTextures_0), (colorSampler_0), ((_S21)).xy, i32(((_S21)).z), (_S16), (_S17))), vec4<f32>(ratio_0));
                var _S23 : f32 = mix(uboFS_0.material_0.data_3[i_1].reflectivity_0, uboFS_0.material_0.data_3[_S20].reflectivity_0, ratio_0);
                shineDamper_2 = mix(uboFS_0.material_0.data_3[i_1].shineDamper_0, uboFS_0.material_0.data_3[_S20].shineDamper_0, ratio_0);
                reflectivity_2 = _S23;
                textureColor_0 = _S22;
                break;
            }
            else
            {
                if(_S14 < (uboFS_0.heightSteps_0[i_1].x - uboFS_0.heightTransitionRange_0))
                {
                    var _S24 : vec3<f32> = vec3<f32>(_S12.textureCoord_0, f32(i_1));
                    var _S25 : vec4<f32> = (textureSampleGrad((colorTextures_0), (colorSampler_0), ((_S24)).xy, i32(((_S24)).z), (_S16), (_S17)));
        ...
        {
            var _S26 : vec3<f32> = vec3<f32>(_S12.textureCoord_0, f32(i_1));
            var _S27 : vec4<f32> = (textureSampleGrad((colorTextures_0), (colorSampler_0), ((_S26)).xy, i32(((_S26)).z), (_S16), (_S17)));
            shineDamper_2 = uboFS_0.material_0.data_3[i_1].shineDamper_0;
            reflectivity_2 = uboFS_0.material_0.data_3[i_1].reflectivity_0;
            textureColor_0 = _S27;
            break;
    ...
    var _S28 : vec3<f32> = normalize(_S12.normal_2);
    var _S29 : vec3<f32> = normalize(_S12.toCameraVector_1);
    var _S30 : vec3<f32> = vec3<f32>(0.0f);
    var j_0 : u32 = u32(0);
    var totalDiffuse_0 : vec3<f32> = _S30;
    var totalSpecular_0 : vec3<f32> = _S30;
    for(;;)
    {
        ...
        var unitToLightVector_0 : vec3<f32> = normalize(_S13[j_0]);
        var attenuationFactor_2 : f32 = GetAttenuationFactor_0(uboFS_0.lightning_0.lights_0.data_2[j_0].attenuation_0.xyz, _S13[j_0]);
        var _S31 : vec3<f32> = uboFS_0.lightning_0.lights_0.data_2[j_0].color_0.xyz;
        var totalDiffuse_1 : vec3<f32> = totalDiffuse_0 + GetDiffuseColor_0(_S28, unitToLightVector_0, _S31, attenuationFactor_2);
        var totalSpecular_1 : vec3<f32> = totalSpecular_0 + GetSpecularColor_0(_S28, unitToLightVector_0, _S29, _S31, attenuationFactor_2, shineDamper_2, reflectivity_2);
        j_0 = j_0 + u32(1);
    ...
    var _S32 : pixelOutput_0 = pixelOutput_0( resultColor_1 );
    return _S32;
}
