...
std::unique_ptr<IRenderComponent> RenderComponentFactory::CreateCubeRenderComponent(const glm::vec4& color, const bool castsShadows, const bool isCastedByShadows) const
{
    ...
    auto material = CreateMaterial(*allocator, color, false, 10.0f, 1.0f);
...
std::unique_ptr<IRenderComponent> RenderComponentFactory::CreatePlaneRenderComponent(const glm::vec4& color, const bool castsShadows, const bool isCastedByShadows) const
{
    ...
    auto material = CreateMaterial(*allocator, color, true, 2.0f, 0.3f);
...
std::unique_ptr<IRenderComponent> RenderComponentFactory::CreateModelRenderComponent(const std::string& modelPath, const std::vector<glm::vec4>& colors, const bool castsShadows, const bool isCastedByShadows) const
{
    ...
    for (const auto color : colors) {
        materials.emplace_back(CreateMaterial(*allocator, color, true, 2.0f, 0.3f));
    }
...
std::unique_ptr<IAnimationRenderComponent> RenderComponentFactory::CreateAnimatedModelRenderComponent(const std::string& modelPath, const std::vector<std::string>& animationPaths, const std::vector<glm::vec4>& colors, const bool castsShadows, const bool isCastedByShadows) const
{
    ...
    std::vector<std::shared_ptr<prev_test::render::IMaterial> > materials;
    for (const auto& color : colors) {
        materials.emplace_back(CreateMaterial(*allocator, color, true, 1.5f, 0.3f));
    }
...
std::unique_ptr<prev_test::render::IMaterial> RenderComponentFactory::CreateMaterial(prev::core::memory::Allocator& allocator, const glm::vec4& color, const bool repeatAddressMode, const float shineDamper, const float reflectivity) const
{
    prev_test::render::material::MaterialFactory materialFactory{};
    return materialFactory.Create({ color, shineDamper, reflectivity });
}
...
std::unique_ptr<prev_test::render::IMaterial> RenderComponentFactory::CreateMaterial(prev::core::memory::Allocator& allocator, const std::string& texturePath, const bool repeatAddressMode, const float shineDamper, const float reflectivity) const
{
    ...
    prev_test::render::material::MaterialFactory materialFactory{};
    return materialFactory.Create({ glm::vec4{ 1.0f }, shineDamper, reflectivity }, { image, std::move(imageBuffer) });
}
...
std::unique_ptr<prev_test::render::IMaterial> RenderComponentFactory::CreateMaterial(prev::core::memory::Allocator& allocator, const std::string& texturePath, const std::string& normalMapPath, const bool repeatAddressMode, const float shineDamper, const float reflectivity) const
{
    ...
    prev_test::render::material::MaterialFactory materialFactory{};
    return materialFactory.Create({ glm::vec4{ 1.0f }, shineDamper, reflectivity }, { image, std::move(imageBuffer) }, { normalImage, std::move(normalImageBuffer) });
}
...
std::unique_ptr<prev_test::render::IMaterial> RenderComponentFactory::CreateMaterial(prev::core::memory::Allocator& allocator, const std::string& texturePath, const std::string& normalMapPath, const std::string& heightMapPath, const bool repeatAddressMode, const float shineDamper, const float reflectivity) const
{
    ...
    prev_test::render::material::MaterialFactory materialFactory{};
    return materialFactory.Create({ glm::vec4{ 1.0f }, shineDamper, reflectivity }, { image, std::move(imageBuffer) }, { normalImage, std::move(normalImageBuffer) }, { heightImage, std::move(heightImageBuffer) });
}
