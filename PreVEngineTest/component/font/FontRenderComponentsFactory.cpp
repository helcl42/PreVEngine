...
std::unique_ptr<IFontRenderComponent> FontRenderComponentsFactory::Create(const std::string& fontPath, const std::string& fontTexture, const float aspectRatio) const
{
