...
public:
    RayCastDebugRenderer(prev::core::device::Device& device, prev::core::memory::Allocator& allocator, prev::render::pass::RenderPass& renderPass, prev::scene::IScene& scene);
...
private:
    ...
    std::unique_ptr<prev::render::buffer::BufferPool> m_uniformsPoolGS;
