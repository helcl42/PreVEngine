#ifndef __NORMAL_MAPPED_RENDERER_H__
#define __NORMAL_MAPPED_RENDERER_H__
...
public:
    NormalMappedRenderer(prev::core::device::Device& device, prev::core::memory::Allocator& allocator, prev::render::pass::RenderPass& renderPass);
...
#endif // !__NORMAL_MAPPED_RENDERER_H__
