#ifndef __FONT_3D_RENDERER_H__
#define __FONT_3D_RENDERER_H__
...
class Font3dRenderer final : public IRenderer<NormalRenderContext> {
public:
    Font3dRenderer(prev::core::device::Device& device, prev::core::memory::Allocator& allocator, prev::render::pass::RenderPass& renderPass, prev::scene::IScene& scene);

    ~Font3dRenderer() = default;
