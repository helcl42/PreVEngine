...
C:/VulkanSDK/1.2.131.2/Bin/glslangValidator.exe -V terrain_shadows.vert
...
C:/VulkanSDK/1.2.131.2/Bin/glslangValidator.exe -V animation_normal_mapped_shadows.vert
