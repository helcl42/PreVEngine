...
layout(location = 7) out vec3 outNornal;
layout(location = 8) out vec3 outToCameraVectorTangentSpace;
layout(location = 9) out vec3 outWorldPositionTangentSpace;
layout(location = 10) out vec3 outToLightVectorTangentSpace[MAX_LIGHT_COUNT];
