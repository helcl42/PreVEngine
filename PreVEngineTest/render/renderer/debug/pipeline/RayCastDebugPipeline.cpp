...
bool RayCastDebugPipeline::Init()
{
    ...
    pipelineFactory.CreateDefaultPipeline(m_device, m_shaders, m_renderPass, VK_PRIMITIVE_TOPOLOGY_POINT_LIST, true, true, false, true, 1, m_pipelineLayout, m_pipeline);
