...
class AnimationTexturelessRenderer final : public prev::render::IRenderer<NormalRenderContextUserData> {
public:
    AnimationTexturelessRenderer(const std::shared_ptr<prev::render::pass::RenderPass>& renderPass);
