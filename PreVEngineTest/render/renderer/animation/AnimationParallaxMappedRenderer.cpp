...
void AnimationParallaxMappedRenderer::BeforeRender(const NormalRenderContext& renderContext)
{
}

void AnimationParallaxMappedRenderer::PreRender(const NormalRenderContext& renderContext)
{
...
void AnimationParallaxMappedRenderer::Render(const NormalRenderContext& renderContext, const std::shared_ptr<prev::scene::graph::ISceneNode>& node)
{
...
void AnimationParallaxMappedRenderer::PostRender(const NormalRenderContext& renderContext)
{
}

void AnimationParallaxMappedRenderer::AfterRender(const NormalRenderContext& renderContext)
{
}
...
void AnimationParallaxMappedRenderer::RenderMeshNode(const NormalRenderContext& renderContext, const std::shared_ptr<prev::scene::graph::ISceneNode>& node, const prev_test::render::MeshNode& meshNode)
{
