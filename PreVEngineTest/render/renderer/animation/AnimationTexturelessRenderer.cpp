...
#include "pipeline/AnimationTexturelessPipeline.h"
#include "shader/AnimationTexturelessShader.h"
...
AnimationTexturelessRenderer::AnimationTexturelessRenderer(const std::shared_ptr<prev::render::pass::RenderPass>& renderPass)
    : m_renderPass(renderPass)
{
}

void AnimationTexturelessRenderer::Init()
{
    ...
    m_pipeline = std::make_unique<pipeline::AnimationTexturelessPipeline>(*device, *m_shader, *m_renderPass);
    m_pipeline->Init();
...
void AnimationTexturelessRenderer::BeforeRender(const prev::render::RenderContext& renderContext, const NormalRenderContextUserData& renderContextUserData)
{
}

void AnimationTexturelessRenderer::PreRender(const prev::render::RenderContext& renderContext, const NormalRenderContextUserData& renderContextUserData)
{
...
void AnimationTexturelessRenderer::Render(const prev::render::RenderContext& renderContext, const std::shared_ptr<prev::scene::graph::ISceneNode>& node, const NormalRenderContextUserData& renderContextUserData)
{
...
void AnimationTexturelessRenderer::PostRender(const prev::render::RenderContext& renderContext, const NormalRenderContextUserData& renderContextUserData)
{
}

void AnimationTexturelessRenderer::AfterRender(const prev::render::RenderContext& renderContext, const NormalRenderContextUserData& renderContextUserData)
{
}
...
void AnimationTexturelessRenderer::RenderMeshNode(const prev::render::RenderContext& renderContext, const std::shared_ptr<prev::scene::graph::ISceneNode>& node, const NormalRenderContextUserData& renderContextUserData, const prev_test::render::MeshNode& meshNode)
{
