...
std::vector<VkVertexInputAttributeDescription> AnimatedBumplMappedShadowsShader::CreateInputAttributeDescriptors() const
{
    return {
...
std::vector<prev::render::shader::Shader::DescriptorSet> AnimatedBumplMappedShadowsShader::CreateDescriptorSets() const
{
    return {
        // vertex shader
...
std::vector<prev::render::shader::Shader::PushConstantBlock> AnimatedBumplMappedShadowsShader::CreatePushConstantBlocks() const
{
    return {};
}
} // namespace prev_test::render::renderer::shadow::shader
