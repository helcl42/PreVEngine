...
TerrainBumpMappedShadowsPipeline::TerrainBumpMappedShadowsPipeline(const VkDevice device, const VkRenderPass renderpass, const prev::render::shader::Shader& shaders)
