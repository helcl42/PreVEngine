...
void ParallaxMappedRenderer::BeforeRender(const NormalRenderContext& renderContext)
{
}

void ParallaxMappedRenderer::PreRender(const NormalRenderContext& renderContext)
{
...
void ParallaxMappedRenderer::Render(const NormalRenderContext& renderContext, const std::shared_ptr<prev::scene::graph::ISceneNode>& node)
{
...
void ParallaxMappedRenderer::AfterRender(const NormalRenderContext& renderContext)
{
}
...
void ParallaxMappedRenderer::RenderMeshNode(const NormalRenderContext& renderContext, const std::shared_ptr<prev::scene::graph::ISceneNode>& node, const prev_test::render::MeshNode& meshNode)
{
