...
void DefaultRenderer::Init()
{
    ...
    m_shader = shaderFactory.CreateShaderFromFiles<shader::DefaultShader>(*device, shader::DefaultShader::GetPaths());
...
void DefaultRenderer::Render(const prev::render::RenderContext& renderContext, const std::shared_ptr<prev::scene::graph::ISceneNode>& node, const NormalRenderContextUserData& renderContextUserData)
{
...
void DefaultRenderer::RenderMeshNode(const prev::render::RenderContext& renderContext, const std::shared_ptr<prev::scene::graph::ISceneNode>& node, const NormalRenderContextUserData& renderContextUserData, const prev_test::render::MeshNode& meshNode)
{
