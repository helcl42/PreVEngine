...
std::map<VkShaderStageFlagBits, std::string> ParallaxMappedShader::GetPaths()
{
    return {
        { VK_SHADER_STAGE_VERTEX_BIT, prev_test::common::AssetManager::Instance().GetAssetPath("Shaders/normal/parallax_mapped_vert.spv") },
        { VK_SHADER_STAGE_FRAGMENT_BIT, prev_test::common::AssetManager::Instance().GetAssetPath("Shaders/normal/parallax_mapped_frag.spv") }
    };
}

std::vector<VkVertexInputBindingDescription> ParallaxMappedShader::CreateVertexInputBindingDescriptors() const
{
    return {
...
std::vector<VkVertexInputAttributeDescription> ParallaxMappedShader::CreateInputAttributeDescriptors() const
{
    return {
...
std::vector<prev::render::shader::Shader::DescriptorSet> ParallaxMappedShader::CreateDescriptorSets() const
{
    return {
        // vertex shader
...
std::vector<prev::render::shader::Shader::PushConstantBlock> ParallaxMappedShader::CreatePushConstantBlocks() const
{
    return {};
}
} // namespace prev_test::render::renderer::normal::shader
