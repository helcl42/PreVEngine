...
std::unique_ptr<prev_test::render::IMesh> MeshFactory::Create(const std::string& modelPath, const prev::common::FlagSet<CreateFlags>& flags) const
{
...
void MeshFactory::ReadNodeHierarchy(const aiNode* node, const glm::mat4& parentTransform, std::vector<glm::mat4>& transforms) const
{
...
prev_test::render::VertexLayout MeshFactory::GetVertexLayout(const prev::common::FlagSet<CreateFlags>& flags) const
{
...
void MeshFactory::ReadIndices(const aiMesh& mesh, std::vector<uint32_t>& inOutIndices) const
{
...
void MeshFactory::AddDefaultVertexData(const aiMesh& mesh, const uint32_t vertexIndex, prev_test::render::VertexDataBuffer& inOutVertexBuffer) const
{
...
void MeshFactory::AddAnimationData(const std::vector<VertexBoneData>& vertexBoneData, const uint32_t vertexIndex, prev_test::render::VertexDataBuffer& inOutVertexBuffer) const
{
...
void MeshFactory::AddBumpMappingData(const aiMesh& mesh, const unsigned int vertexIndex, prev_test::render::VertexDataBuffer& inOutVertexBuffer) const
{
...
void MeshFactory::ReadVertexData(const aiMesh& mesh, const prev::common::FlagSet<CreateFlags>& flags, const std::vector<VertexBoneData>& vertexBoneData, const uint32_t vertexBaseOffset, prev_test::render::VertexDataBuffer& inOutVertexBuffer) const
{
...
std::vector<VertexBoneData> MeshFactory::LoadAnimationBones(const aiMesh& mesh, const uint32_t vertexBaseOffset) const
{
...
unsigned int MeshFactory::GetAllVertexCount(const aiScene& scene) const
{
...
unsigned int MeshFactory::ReadMeshes(const aiScene& scene, const prev::common::FlagSet<CreateFlags>& flags, prev_test::render::VertexDataBuffer& inOutVertexBuffer, std::vector<glm::vec3>& inOutVertices, std::vector<uint32_t>& inOutIndices, std::vector<MeshPart>& inOutMeshParts) const
{
