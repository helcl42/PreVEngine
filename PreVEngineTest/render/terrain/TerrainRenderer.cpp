...
namespace prev_test::render::terrain {
...
void TerrainRenderer::Init()
{
    ...
    m_shader = shaderFactory.CreateShaderFromFiles<prev_test::render::terrain::shader::TerrainShader>(*device, { { VK_SHADER_STAGE_VERTEX_BIT, AssetManager::Instance().GetAssetPath("Shaders/terrain_vert.spv") }, { VK_SHADER_STAGE_FRAGMENT_BIT, AssetManager::Instance().GetAssetPath("Shaders/terrain_frag.spv") } });
    m_shader->AdjustDescriptorPoolCapacity(m_descriptorCount);

    LOGI("Terrain Shader created\n");

    m_pipeline = std::make_unique<prev_test::render::terrain::pipeline::TerrainPipeline>(*device, *m_renderPass, *m_shader);
    m_pipeline->Init();
