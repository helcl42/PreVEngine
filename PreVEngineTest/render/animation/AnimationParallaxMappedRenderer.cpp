...
void AnimationParallaxMappedRenderer::Init()
{
    ...
    m_shader = shaderFactory.CreateShaderFromFiles<prev_test::render::animation::shader::AnimationParallaxMappedShader>(*device, { { VK_SHADER_STAGE_VERTEX_BIT, AssetManager::Instance().GetAssetPath("Shaders/animation_parallax_mapped_vert.spv") }, { VK_SHADER_STAGE_FRAGMENT_BIT, AssetManager::Instance().GetAssetPath("Shaders/animation_parallax_mapped_frag.spv") } });
    m_shader->AdjustDescriptorPoolCapacity(m_descriptorCount);

    LOGI("Animation Parallax Mapped Shader created\n");

    m_pipeline = std::make_unique<prev_test::render::animation::pipeline::AnimationParallaxMappedPipeline>(*device, *m_renderPass, *m_shader);
    m_pipeline->Init();
