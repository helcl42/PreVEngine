...
namespace prev_test::render::water::pipeline {
WaterPipeline::WaterPipeline(const VkDevice device, const VkRenderPass renderpass, const prev::render::shader::Shader& shaders)
    : AbstractGraphicsPipeline(device, renderpass, shaders)
{
}

VkPipeline WaterPipeline::Init()
{
