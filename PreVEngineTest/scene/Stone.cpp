...
Stone::Stone(const glm::vec3& position, const glm::quat& orientation, const glm::vec3& scale)
    : SceneNode()
...
void Stone::Init()
{
    ...
    m_boundingVolumeComponent = bondingVolumeFactory.CreateAABB(renderComponent->GetModel()->GetMesh()->GetVertices(), 80.0f);
