...
public:
    std::unique_ptr<prev_test::render::IModel> CreateAABBModel(const AABB& aabb) const
    {
    ...
    std::unique_ptr<prev_test::render::IModel> CreateSphereModel(const Sphere& sphere) const
    {
