...
void Engine::ResetRenderPass()
{
    ...
    if (sampleCount > VK_SAMPLE_COUNT_1_BIT) {
        ...
        m_renderPass = renderPassBuilder
                           ...
                           .AddDepthAttachment(depthFormat, VK_SAMPLE_COUNT_1_BIT, { MAX_DEPTH, 0 }, VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL, VK_ATTACHMENT_LOAD_OP_CLEAR, VK_ATTACHMENT_STORE_OP_DONT_CARE, true) // depth buffer, resolve buffer
        ...
        m_renderPass = renderPassBuilder
                           ...
                           .AddDepthAttachment(depthFormat, VK_SAMPLE_COUNT_1_BIT, { MAX_DEPTH, 0 }, VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL, VK_ATTACHMENT_LOAD_OP_CLEAR, VK_ATTACHMENT_STORE_OP_DONT_CARE)
                           .AddSubpass({ 0, 1 })
                           .AddSubpassDependencies(dependencies)
                           .Build();
    }
